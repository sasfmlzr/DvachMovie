...
open class NeoChanUseCase @Inject constructor(private val getThreadUseCase: GetThreadsFromNeoChanUseCase,
                                              ...
                                              GetLinkFilesFromThreadsNeoChanUseCase,
    ...
    override suspend fun executeAsync(input: DvachUseCase.Params) {
        ...
        val inputModel = GetThreadsFromNeoChanUseCase.Params(input.board)
    ...
    private suspend fun executeLinkFilesUseCase(num: String, nameThread: String): List<FileItem> {
        return try {
            val inputModel = GetLinkFilesFromThreadsNeoChanUseCase.Params(board, num, nameThread)
