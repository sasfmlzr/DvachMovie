...
open class GetLinkFilesFromThreadsNeoChanUseCase @Inject constructor(
    ...
    override suspend fun executeAsync(input: Params): GetLinkFilesFromThreadsUseCaseModel =
            try {
                val listFiles = neoChanRepository.getConcreteThreadByNum(
                                input.board, input.numThread, input.nameThread)
